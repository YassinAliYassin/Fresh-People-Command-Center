          ...
          <div className="glass-panel rounded-lg p-5 shadow-luxury-glow flex flex-col">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              ...
              <div className="bg-white border border-slate-200/60 rounded-md p-2.5 text-center">
                ...
                <span className="text-[7px] text-slate-500 uppercase tracking-widest font-bold mt-1 block">Total Events</span>
              </div>
              {/* Staff Count */}
              <div className="bg-white border border-slate-200/60 rounded-md p-2.5 text-center">
              ...
              <div className="bg-emerald-50/60 border border-emerald-200/60 rounded-md p-2.5 text-center">
                <span className="text-[18px] font-extrabold text-emerald-700 font-mono leading-none block">{events.filter(e => e.status === 'Confirmed').length}</span>
                <span className="text-[7px] text-emerald-600 uppercase tracking-widest font-bold mt-1 block">Confirmed</span>
              </div>
              {/* Pending */}
            ...
            {(() => {
              ...
              const upcomingCount = events.filter(e => e.date >= todayStr && e.date <= nextWeekStr && e.status !== 'Canceled').length;
              return (
                <div className="mt-2.5 bg-gold-50/40 border border-gold-200/40 rounded-md p-2.5 flex items-center justify-between">
                  <div>
                    <span className="text-[9px] text-gold-700 font-extrabold uppercase tracking-wider">Next 7 Days</span>
                    <span className="text-[8px] text-slate-500 font-semibold block mt-0.5">Upcoming confirmed & pending</span>
                  </div>
